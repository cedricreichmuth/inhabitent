 ...
 *
 * The Inhabitent business hours widget is an organized, maintainable boilerplate for building widgets using WordPress best practices.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent business hours widget
 * @author    Cedric Reichmuth <cedric.reichmuth@gmail.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        bizhours.com
 * Description:       Simple widget to generate business hours
 * Version:           1.0.0
 * Author:            Cedric Reichmuth
